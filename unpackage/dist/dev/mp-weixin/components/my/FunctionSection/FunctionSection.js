...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    d: common_vendor.o(($event) => $options.navigateTo("/pages/my/function/myAccept")),
    e: common_vendor.p({
      type: "wallet",
      size: "24",
      color: "#f1c40f"
    }),
    f: common_vendor.o(($event) => $options.navigateTo("/pages/my/function/myWallet")),
    g: common_vendor.p({
      type: "gear",
      size: "24",
      color: "#95a5a6"
    }),
    h: common_vendor.o(($event) => $options.navigateTo("/pages/my/function/settings"))
  };
}
